...
@app.post("/administrator", status_code=status.HTTP_201_CREATED)
...
@app.get("/administrator/{id}", response_model=schemas.AdministratorResponse)
...
@app.get("/administrator", response_model=List[schemas.AdministratorResponse])
...
@app.put("/administrator/{id}", response_model=schemas.AdministratorResponse)
...
# Delete Admission
@app.delete("/administrator/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
def create_adverse_reaction_type(adverse_reaction_type: schemas.AdverseReactionTypeCreate, db: Session = Depends(get_db)):
    new_adverse_reaction_type = models.AdverseReactionType(
...
@app.post("/appointment_type", status_code=status.HTTP_201_CREATED)
...
@app.get("/appointment_type/{id}", response_model=schemas.AppointmentTypeResponse)
...
@app.get("/appointment_type", response_model=List[schemas.AppointmentTypeResponse])
...
@app.put("/appointment_type/{id}", response_model=schemas.AppointmentTypeResponse)
...
@app.delete("/appointment_type/{id}", status_code=status.HTTP_204_NO_CONTENT)
def delete_appointment_type(id: int, db: Session = Depends(get_db)):

    appointment_type = db.query(models.AppointmentType).filter(
        models.AppointmentType.id == id)

    if appointment_type.first() == None:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND,
                            detail=f"Appointment type with id: {id} does not exist")

    appointment_type.delete(synchronize_session=False)
    db.commit()
    return Response(status_code=status.HTTP_204_NO_CONTENT)
...
@app.post("/insurance_provider_type", status_code=status.HTTP_201_CREATED)
...
@app.get("/insurance_provider_type/{id}", response_model=schemas.InsuranceProviderTypeResponse)
...
@app.get("/insurance_provider_type", response_model=List[schemas.InsuranceProviderTypeResponse])
...
@app.put("/insurance_provider_type/{id}", response_model=schemas.InsuranceProviderTypeResponse)
...
# Delete insurance provider
@app.delete("/insurance_provider_type/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
@app.post("/it_staff", status_code=status.HTTP_201_CREATED)
...
@app.get("/it_staff/{id}", response_model=schemas.ItstaffResponse)
...
@app.get("/it_staff", response_model=List[schemas.ItstaffResponse])
...
@app.put("/it_staff/{id}", response_model=schemas.ItstaffResponse)
...
# Delete IT Staff
@app.delete("/it_staff/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
@app.post("/lab_technician", status_code=status.HTTP_201_CREATED)
...
@app.get("/lab_technician/{id}", response_model=schemas.LabTechnicianResponse)
...
@app.get("/lab_technician", response_model=List[schemas.LabTechnicianResponse])
...
@app.put("/lab_technician/{id}", response_model=schemas.LabTechnicianResponse)
...
# Delete lab test
@app.delete("/lab_technician/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
def get_lab_test_result(id: int, db: Session = Depends(get_db)):
    lab_test_result = db.query(models.LabTestResult).filter(
        models.LabTestResult.id == id).first()
...
def update_lab_test_result(id: int, updated_lab_test_result: schemas.LabTestResultCreate, db: Session = Depends(get_db)):
    ...
    lab_test_result_query = db.query(models.LabTestResult).filter(
        models.LabTestResult.id == id)
    ...
    lab_test_result_query.update(
        updated_lab_test_result.dict(), synchronize_session=False)
    db.commit()
...
@app.post("/nurse", status_code=status.HTTP_201_CREATED)
...
@app.get("/nurse/{id}", response_model=schemas.NurseResponse)
...
@app.get("/nurse", response_model=List[schemas.NurseResponse])
...
@app.put("/nurse/{id}", response_model=schemas.NurseResponse)
...
# Delete nurse
@app.delete("/nurse/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
@app.post("/pharmacist", status_code=status.HTTP_201_CREATED)
...
@app.get("/pharmacist/{id}", response_model=schemas.PharmacistResponse)
...
@app.get("/pharmacist", response_model=List[schemas.PharmacistResponse])
...
@app.put("/pharmacist/{id}", response_model=schemas.PharmacistResponse)
...
# Delete pharmacist
@app.delete("/pharmacist/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
@app.post("/receptionist", status_code=status.HTTP_201_CREATED)
...
@app.get("/receptionist/{id}", response_model=schemas.ReceptionistResponse)
...
@app.get("/receptionist", response_model=List[schemas.ReceptionistResponse])
...
@app.put("/receptionist/{id}", response_model=schemas.ReceptionistResponse)
...
# Delete receptionist
@app.delete("/receptionist/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
@app.post("/specialty", status_code=status.HTTP_201_CREATED)
...
@app.get("/specialty/{id}", response_model=schemas.SpecialtyResponse)
...
@app.get("/specialty", response_model=List[schemas.SpecialtyResponse])
...
@app.put("/specialty/{id}", response_model=schemas.SpecialtyResponse)
...
# Delete specialty
@app.delete("/specialty/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
def get_user_account(id: str, db: Session = Depends(get_db)):
...
@app.post("/work_schedule", status_code=status.HTTP_201_CREATED)
...
@app.get("/work_schedule/{id}", response_model=schemas.WorkScheduleResponse)
...
@app.get("/work_schedule", response_model=List[schemas.WorkScheduleResponse])
...
@app.put("/work_schedule/{id}", response_model=schemas.WorkScheduleResponse)
...
@app.delete("/work_schedule/{id}", status_code=status.HTTP_204_NO_CONTENT)
