...
import "./adverseReactionTable.scss";
import SearchOutlinedIcon from "@mui/icons-material/SearchOutlined";
import { Button } from "@mui/material";
import AdverseReactionForm from "../adverse_reaction/AdverseReactionForm";
import AdverseReactionEdit from "../adverse_reaction/AdverseReactionEdit";
import AdverseReactionView from "../adverse_reaction/AdverseReactionView";
...
export default function AdverseReactionTable() {
  const columns = [
    ...
    {
      field: "reaction_date",
      headerName: "Reaction Date",
      width: 100,
      editable: true,
    },
    {
      field: "reaction_time",
      headerName: "Reaction Time",
      width: 160,
      editable: true,
    },
    {
  ...
  const handleDelete = async (id, e) => {
    ...
    await axios
      .delete(`http://127.0.0.1:8000/adverse_reaction/${id}`)
      .then((res) => {
    ...
    <div className="datatable">
      <div className="datatableTitle">
        ...
        <div className="search">
          <input
            type="text"
            placeholder="Search adverse reaction table..."
            value={searchTerm}
      ...
      <div>
        {selectedRow && (
          <Modal open={openEditForm} onClose={handleCloseEditForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <AdverseReactionEdit selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
      ...
      <div>
        {selectedRow && (
          <Modal open={openViewForm} onClose={handleCloseViewForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <AdverseReactionView selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
