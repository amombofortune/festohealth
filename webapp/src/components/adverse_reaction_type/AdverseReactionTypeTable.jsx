...
import "./adverseReactionTypeTable.scss";
import SearchOutlinedIcon from "@mui/icons-material/SearchOutlined";
import { Button } from "@mui/material";

import AdverseReactionTypeEdit from "../adverse_reaction_type/AdverseReactionTypeEdit";
import AdverseReactionTypeForm from "../adverse_reaction_type/AdverseReactionTypeForm";
import AdverseReactionTypeView from "../adverse_reaction_type/AdverseReactionTypeView";
...
export default function AdverseReactionTypeTable() {
  const columns = [
  ...
  const handleDelete = async (id, e) => {
    ...
    await axios
      .delete(`http://127.0.0.1:8000/adverse_reaction_type/${id}`)
      .then((res) => {
      ...
      <div>
        {selectedRow && (
          <Modal open={openEditForm} onClose={handleCloseEditForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <AdverseReactionTypeEdit selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
      ...
      <div>
        {selectedRow && (
          <Modal open={openViewForm} onClose={handleCloseViewForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <AdverseReactionTypeView selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
