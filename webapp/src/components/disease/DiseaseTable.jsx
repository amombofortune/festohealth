...
import DiseaseForm from "../disease/DiseaseForm";
import DiseaseEdit from "../disease/DiseaseEdit";
import DiseaseView from "../disease/DiseaseView";
...
export default function DiseaseTable() {
  ...
  const handleDelete = async (id, e) => {
    ...
    await axios
      .delete(`http://127.0.0.1:8000/disease/${id}`)
      .then((res) => {
      ...
      <div>
        {selectedRow && (
          <Modal open={openEditForm} onClose={handleCloseEditForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <DiseaseEdit selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
      ...
      <div>
        {selectedRow && (
          <Modal open={openViewForm} onClose={handleCloseViewForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <DiseaseView selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
