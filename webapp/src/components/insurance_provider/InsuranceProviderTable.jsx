...
import "./insuranceProviderTable.scss";
import SearchOutlinedIcon from "@mui/icons-material/SearchOutlined";
import { Button } from "@mui/material";

import InsuranceProviderForm from "../insurance_provider/InsuranceProviderForm";
import InsuranceProviderEdit from "../insurance_provider/InsuranceProviderEdit";
import InsuranceProviderView from "../insurance_provider/InsuranceProviderView";
...
export default function InsuranceProviderTable() {
  ...
  const handleDelete = async (id, e) => {
    ...
    await axios
      .delete(`http://127.0.0.1:8000/insurance_provider/${id}`)
      .then((res) => {
    ...
    <div className="datatable">
      <div className="datatableTitle">
        ...
        <div className="search">
          <input
            type="text"
            placeholder="Search insurance provider table..."
            value={searchTerm}
      ...
      <div>
        {selectedRow && (
          <Modal open={openEditForm} onClose={handleCloseEditForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <InsuranceProviderEdit selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
      ...
      <div>
        {selectedRow && (
          <Modal open={openViewForm} onClose={handleCloseViewForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <InsuranceProviderView selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
