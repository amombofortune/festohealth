...
import "./medicalNoteTable.scss";
import SearchOutlinedIcon from "@mui/icons-material/SearchOutlined";
import { Button } from "@mui/material";

import MedicalNoteForm from "../medical_note/MedicalNoteForm";
import MedicalNoteEdit from "../medical_note/MedicalNoteEdit";
import MedicalNoteView from "../medical_note/MedicalNoteView";
...
export default function MedicalNoteTable() {
  const columns = [
  ...
  const handleDelete = async (id, e) => {
    ...
    await axios
      .delete(`http://127.0.0.1:8000/medical_note/${id}`)
      .then((res) => {
      ...
      <div>
        {selectedRow && (
          <Modal open={openEditForm} onClose={handleCloseEditForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <MedicalNoteEdit selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
      ...
      <div>
        {selectedRow && (
          <Modal open={openViewForm} onClose={handleCloseViewForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <MedicalNoteView selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
