...
import "./medicationAlertTable.scss";
import SearchOutlinedIcon from "@mui/icons-material/SearchOutlined";
import { Button } from "@mui/material";

import MedicationAlertForm from "../medication_alert/MedicationAlertForm";
import MedicationAlertView from "../medication_alert/MedicationAlertView";
import MedicationAlertEdit from "../medication_alert/MedicationAlertEdit";
...
export default function MedicationAlertTable() {
  const columns = [
  ...
  const handleDelete = async (id, e) => {
    ...
    await axios
      .delete(`http://127.0.0.1:8000/medical_alert/${id}`)
      .then((res) => {
    ...
    <div className="datatable">
      <div className="datatableTitle">
        ...
        <div className="search">
          <input
            type="text"
            placeholder="Search medication alert table..."
            value={searchTerm}
      ...
      <div>
        {selectedRow && (
          <Modal open={openEditForm} onClose={handleCloseEditForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <MedicationAlertEdit selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
      ...
      <div>
        {selectedRow && (
          <Modal open={openViewForm} onClose={handleCloseViewForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <MedicationAlertView selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
