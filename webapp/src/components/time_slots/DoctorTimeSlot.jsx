...
const DoctorTimeSlot = () => {
  ...
  const [appointment_start_time, setStartTime] = useState("08:00 AM");
  const [appointment_end_time, setEndTime] = useState("05:00 PM");
  ...
  const handleSubmit = async (e) => {
    ...
    setStartTime(appointment_start_time);
    setEndTime(appointment_end_time);
    ...
    await axios
      .post("http://127.0.0.1:8000/time_slot", {
        doctor_id,
        appointment_date,
        appointment_start_time: selectedStartTime,
        appointment_end_time: selectedEndTime,
        availability,
      })
      .then((res) => {
