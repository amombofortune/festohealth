...
import VaccinationView from "../vaccination/VaccinationView";
...
export default function Trial() {
  const columns = [
    ...
    },
    {
      ...
      headerName: "Administered By",
      width: 160,
      editable: true,
    },
    {
      field: "administered_at",
      headerName: "Administered At",
      width: 150,
      editable: true,
    },
    {
      field: "next_dose_due",
      headerName: "Next Dose Due",
      width: 150,
      editable: true,
    },
      ...
      <div>
        {selectedRow && (
          <Modal open={openEditForm} onClose={handleCloseEditForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <VaccinationEdit selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
      ...
      <div>
        {selectedRow && (
          <Modal open={openViewForm} onClose={handleCloseViewForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <VaccinationView selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
