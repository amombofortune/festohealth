  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Handle error fetching ward data
      }
    };
      ...
      <div>
        {selectedRow && (
          <Modal open={openEditForm} onClose={handleCloseEditForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <WardEdit selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
      ...
      <div>
        {selectedRow && (
          <Modal open={openViewForm} onClose={handleCloseViewForm}>
            <Box style={modalStyle}>
              <Box sx={{ width: "100%" }}>
                <WardView selectedRow={selectedRow} />
              </Box>
            </Box>
          </Modal>
        )}
